      ...
      <div className="font-manrope text-white max-w-4xl min-w-2xs mx-4 sm:mx-4 md:mx-auto p-10 md:flex justify-center drop-shadow-lg outline outline-white my-8 rounded-2xl backdrop-blur-xs bg-black/30">
        ...
        <div>
          ...
          <p className="text-lg tracking-tight mx-10 md:mx-0">
            ...
            <p>I am eager to contribute my skills to impactful projects, continue growing as a developer, and build software that makes a difference. I offer my expertise both as a <b>full-time employee </b>or as a freelancer through my company <b>Hynnä Consulting Oy</b>.</p>
          </p>
        </div>
      </div>
    </div >
