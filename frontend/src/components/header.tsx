...
export default function Header() {
  return (
    <div className="App sticky top-0 backdrop-blur-lg z-10 flex justify-between items-center w-full font-custom tracking-tighter">
      <header className="absolute left-1/2 transform -translate-x-1/2 min-h-16">
        <div className="outline outline-1 outline-white rounded-full center m-5 py-5 px-12 flex justify-between text-sm w-96">
