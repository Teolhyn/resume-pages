...
export default function Header() {
  return (
    <div className="sticky bg-white top-0 z-10 flex justify-between items-center w-full font-manrope tracking-tighter h-20">
      <header className="absolute left-1/2 transform -translate-x-1/2 min-h-16 mt-5 mb-5">
        <div className="center m-5 py-5 px-12 flex justify-between text-sm w-96">
          <Link to="/" className="bg-clip-text text-lg text-black text-center select-auto transition-opacity duration-100 hover:opacity-60">Home</Link>
          <Link to="/about" className="bg-clip-text text-lg text-black text-center select-auto transition-opacity duration-100 hover:opacity-60">About</Link>
          <Link to="/projects" className="bg-clip-text text-lg text-black text-center select-auto transition-opacity duration-100 hover:opacity-60">Projects</Link>
        </div>
      </header>
      <div className="flex ml-auto justify-between items-center w-64 text-black mt-5 mb-5 px-14">
